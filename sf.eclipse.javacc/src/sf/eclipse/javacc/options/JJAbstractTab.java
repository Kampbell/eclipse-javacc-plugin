...
public abstract class JJAbstractTab extends Composite 
  ...
  protected void addIntOptionsSection() {
    ...
    for (int i = 0; i < optionSet.getOptionsSize(); i++) {
      if (optionSet.getType(i) != Option.INT)
        continue;
      String label = optionSet.getName(i) + " ("+ JavaccPlugin.getResourceString("JJAbstractTab.default") + optionSet.getDefaultValue(i) + ")";
  ...
  protected void addPathOptionsSection() {
    ...
    new Label(composite,SWT.LEFT | SWT.HORIZONTAL).setText(JavaccPlugin.getResourceString("JJAbstractTab.Select_directory")); //$NON-NLS-1$
    new Label(composite,SWT.LEFT | SWT.HORIZONTAL).setText(JavaccPlugin.getResourceString("JJAbstractTab.Path_can_be_pathSection")); //$NON-NLS-1$
    ...
    for (int i = 0; i < optionSet.getOptionsSize(); i++) {
      ...
      pathField[nb] =
        new DirectoryFieldEditor(
          optionSet.getName(i),
          optionSet.getName(i),
          JavaccPlugin.getResourceString("JJAbstractTab.Choose_a_directory"), //$NON-NLS-1$
  ...
  protected void addFileOptionsSection() {
    ...
    new Label(composite,SWT.LEFT | SWT.HORIZONTAL).setText(JavaccPlugin.getResourceString("JJAbstractTab.Select_file")); //$NON-NLS-1$
    new Label(composite,SWT.LEFT | SWT.HORIZONTAL).setText(JavaccPlugin.getResourceString("JJAbstractTab.Path_can_be_FileSection")); //$NON-NLS-1$
    new Label(composite,SWT.LEFT | SWT.HORIZONTAL).setText(""); //$NON-NLS-1$
