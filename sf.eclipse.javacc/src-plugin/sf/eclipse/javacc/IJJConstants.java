...
public interface IJJConstants {
  ...
  public static final String EXCLUDE_FROM_BUILD = "EXCLUDE_FROM_BUILD"; //$NON-NLS-1$
  ...
  public static final QualifiedName QN_EXCLUDE_FROM_BUILD = new QualifiedName(ID, EXCLUDE_FROM_BUILD);
