 ...
 */
class BooleanFieldEditorJJ extends BooleanFieldEditor {
   ...
   * @see #SEPARATE_LABEL
   */
  public BooleanFieldEditorJJ(final String name, final String labelText, final String toolTipText,
   ...
   * @param parent - the parent of the field editor's control
   */
  public BooleanFieldEditorJJ(final String name, final String label, final String toolTipText,
