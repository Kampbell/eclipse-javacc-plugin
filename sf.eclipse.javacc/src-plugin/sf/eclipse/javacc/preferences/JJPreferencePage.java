 ...
 */
public class JJPreferencePage extends TabbedPreferencePage implements IWorkbenchPreferencePage,
                                                          IPrefConstants {
  ...
  private final String[] atrLabels = {
      "", NLS_FONT_ATR_B, NLS_FONT_ATR_BI, NLS_FONT_ATR_I }; //$NON-NLS-1$

  /** Font attribute button preference values */
  private final String[] atrValues = {
      "" + SWT.NONE, //$NON-NLS-1$
      "" + SWT.BOLD, //$NON-NLS-1$
      "" + (SWT.BOLD + SWT.ITALIC), //$NON-NLS-1$
      "" + SWT.ITALIC             };                       //$NON-NLS-1$ 

  /** The do not show tool tips flag */
  private final boolean  doNotShowToolTips;

  /**
   * Instantiates a new JavaCC preference page.
   */
  public JJPreferencePage() {
    super(GRID);
  ...
  protected void addJavaCCGroup() {
    ...
    addField(new JJColorFieldEditor(P_JAVACC_KEYWORD, NLS_LABEL_JAVACC_KEYWORD, //
                                    tt(NLS_TT_JAVACC_KEYWORD), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_KEYWORD_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_STRING, NLS_LABEL_JAVACC_STRING, //
                                    tt(NLS_TT_JAVACC_STRING), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_STRING_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_NUMERIC, NLS_LABEL_JAVACC_NUMERIC, //
                                    tt(NLS_TT_JAVACC_NUMERIC), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_NUMERIC_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_OTHER_PUNCT, NLS_LABEL_JAVACC_OTHER_PUNCT,
                                    tt(NLS_TT_JAVACC_OTHER_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_OTHER_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_DEFAULT_TEXT, NLS_LABEL_JAVACC_DEFAULT_TEXT, //
                                    tt(NLS_TT_JAVACC_DEFAULT_TEXT), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_DEFAULT_TEXT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_BACKGROUND,
  ...
  protected void addJavaCCHeaderGroup() {
    ...
    addField(new JJColorFieldEditor(P_JAVACC_OPTION, NLS_LABEL_JAVACC_OPTION, //
                                    tt(NLS_TT_JAVACC_OPTION), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_OPTION_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_OPTION_BRACE, NLS_LABEL_JAVACC_OPTION_BRACE, //
                                    tt(NLS_TT_JAVACC_OPTION_BRACE), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_OPTION_BRACE_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_PARSER_NAME, //
                                    NLS_LABEL_JAVACC_PARSER_NAME, //
                                    tt(NLS_TT_JAVACC_PARSER_NAME), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_PARSER_NAME_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_PARSER_NAME_PAREN, NLS_LABEL_JAVACC_PARSER_NAME_PAREN, //
                                    tt(NLS_TT_JAVACC_PARSER_NAME_PAREN), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_PARSER_NAME_PAREN_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));
  }
  ...
  protected void addJJTreeGroup() {
    ...
    addField(new JJColorFieldEditor(P_JJTREE_NODE_NAME_PUNCT, NLS_LABEL_JJTREE_NODE_NAME_PUNCT, //
                                    tt(NLS_TT_JJTREE_NODE_NAME_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_JJTREE_NODE_NAME_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JJTREE_NODE_NAME, NLS_LABEL_JJTREE_NODE_NAME, //
                                    tt(NLS_TT_JJTREE_NODE_NAME), composite_1));

    addField(new CycleButtonFieldEditor(P_JJTREE_NODE_NAME_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JJTREE_NODE_EXPR_PAREN, NLS_LABEL_JJTREE_NODE_EXPR_PAREN, //
                                    tt(NLS_TT_JJTREE_NODE_EXPR_PAREN), composite_1));

    addField(new CycleButtonFieldEditor(P_JJTREE_NODE_EXPR_PAREN_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));
  ...
  protected void addRegExGroup() {
    ...
    addField(new JJColorFieldEditor(P_REG_EX_BRACE, NLS_LABEL_REG_EX_BRACE, //
                                    tt(NLS_TT_REG_EX_BRACE), composite_1));

    addField(new CycleButtonFieldEditor(P_REG_EX_BRACE_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_REG_EX_BRACKET, NLS_LABEL_REG_EX_BRACKET, //
                                    tt(NLS_TT_REG_EX_BRACKET), composite_1));

    addField(new CycleButtonFieldEditor(P_REG_EX_BRACKET_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_REG_EX_TOKEN_PUNCT, NLS_LABEL_REG_EX_TOKEN_PUNCT,
                                    tt(NLS_TT_REG_EX_TOKEN_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_REG_EX_TOKEN_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_REG_EX_CHOICE_PUNCT, NLS_LABEL_REG_EX_CHOICE_PUNCT,
                                    tt(NLS_TT_REG_EX_CHOICE_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_REG_EX_CHOICE_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_REG_EX_OTHER_PUNCT, NLS_LABEL_REG_EX_OTHER_PUNCT,
                                    tt(NLS_TT_REG_EX_OTHER_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_REG_EX_OTHER_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));
  }
  ...
  protected void addTokenLabelsGroup() {
    ...
    addField(new JJColorFieldEditor(P_TOKEN_LABEL, NLS_LABEL_TOKEN_LABEL, //
                                    tt(NLS_TT_TOKEN_LABEL), composite_1));

    addField(new CycleButtonFieldEditor(P_TOKEN_LABEL_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_TOKEN_LABEL_PUNCT, NLS_LABEL_TOKEN_LABEL_PUNCT, //
                                    tt(NLS_TT_TOKEN_LABEL_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_TOKEN_LABEL_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_TOKEN_LABEL_DEF, NLS_LABEL_TOKEN_LABEL_DEF, //
                                    tt(NLS_TT_TOKEN_LABEL_DEF), composite_1));

    addField(new CycleButtonFieldEditor(P_TOKEN_LABEL_DEF_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_TOKEN_LABEL_PRIVATE_DEF_PUNCT, NLS_LABEL_TOKEN_LABEL_PRIVATE_DEF_PUNCT, //
                                    tt(NLS_TT_TOKEN_LABEL_PRIVATE_DEF_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_TOKEN_LABEL_PRIVATE_DEF_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));
    addField(new JJColorFieldEditor(P_TOKEN_LABEL_PRIVATE_DEF, NLS_LABEL_TOKEN_LABEL_PRIVATE_DEF, //
                                    tt(NLS_TT_TOKEN_LABEL_PRIVATE_DEF), composite_1));

    addField(new CycleButtonFieldEditor(P_TOKEN_LABEL_PRIVATE_DEF_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));
  ...
  protected void addLexicalStateGroup() {
    ...
    addField(new JJColorFieldEditor(P_LEXICAL_STATE, NLS_LABEL_LEXICAL_STATE, //
                                    tt(NLS_TT_LEXICAL_STATE), composite_1));

    addField(new CycleButtonFieldEditor(P_LEXICAL_STATE_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_LEXICAL_STATE_PUNCT, NLS_LABEL_LEXICAL_STATE_PUNCT, //
                                    tt(NLS_TT_LEXICAL_STATE_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_LEXICAL_STATE_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_LEXICAL_STATE_NEXT, NLS_LABEL_LEXICAL_STATE_NEXT, //
                                    tt(NLS_TT_LEXICAL_STATE_NEXT), composite_1));

    addField(new CycleButtonFieldEditor(P_LEXICAL_STATE_NEXT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));
  }
  ...
  protected void addBNFChoicesGroup() {
    ...
    addField(new JJColorFieldEditor(P_JAVA_BLOCK_BRACE, NLS_LABEL_JAVA_BLOCK, //
                                    tt(NLS_TT_JAVA_BLOCK), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVA_BLOCK_BRACE_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_EXPANSION_BRACE, NLS_LABEL_JAVACC_EXPANSION_BRACE, //
                                    tt(NLS_TT_JAVACC_EXPANSION_BRACE), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_EXPANSION_BRACE_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVACC_CHOICE_PUNCT, NLS_LABEL_JAVACC_CHOICE_PUNCT, // 
                                    tt(NLS_TT_JAVACC_CHOICE_PUNCT), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVACC_CHOICE_PUNCT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));
  ...
  protected void addJavaBlockBraceGroup() {
    ...
    addField(new JJBooleanFieldEditor(P_JAVA_BLOCK_BRACE_ALT_BG, NLS_LABEL_JAVA_BLOCK_BRACE_ALT_BG, //
  ...
  protected void addJavaGroup() {
    ...
    addField(new JJColorFieldEditor(P_JAVA_KEYWORD, NLS_LABEL_JAVA_KEYWORD, //
                                    tt(NLS_TT_JAVA_KEYWORD), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVA_KEYWORD_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVA_IDENTIFIER, NLS_LABEL_JAVA_IDENTIFIER, //
                                    tt(NLS_TT_JAVA_IDENTIFIER), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVA_IDENTIFIER_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVA_STRING, NLS_LABEL_JAVA_STRING, //
                                    tt(NLS_TT_JAVA_STRING), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVA_STRING_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVA_NUMERIC, NLS_LABEL_JAVA_NUMERIC, //
                                    tt(NLS_TT_JAVA_NUMERIC), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVA_NUMERIC_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVA_PUNCTUATION, NLS_LABEL_JAVA_PUNCTUATION, //
                                    tt(NLS_TT_JAVA_PUNCTUATION), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVA_PUNCTUATION_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVA_DEFAULT_TEXT, NLS_LABEL_JAVA_DEFAULT_TEXT, //
                                    tt(NLS_TT_JAVA_DEFAULT_TEXT), composite_1));

    addField(new CycleButtonFieldEditor(P_JAVA_DEFAULT_TEXT_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_JAVA_BACKGROUND,
  ...
  protected void addCommentColorsGroup() {
    ...
    addField(new JJColorFieldEditor(P_COMMENT_BLOCK, NLS_LABEL_COMMENT_BLOCK, //
                                    tt(NLS_TT_COMMENT_BLOCK), composite_1));

    addField(new CycleButtonFieldEditor(P_COMMENT_BLOCK_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_COMMENT_LINE, NLS_LABEL_COMMENT_LINE, //
                                    tt(NLS_TT_COMMENT_LINE), composite_1));

    addField(new CycleButtonFieldEditor(P_COMMENT_LINE_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_COMMENT_JAVADOC, NLS_LABEL_COMMENT_JAVADOC, //
                                    tt(NLS_TT_COMMENT_JAVADOC), composite_1));

    addField(new CycleButtonFieldEditor(P_COMMENT_JAVADOC_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));

    addField(new JJColorFieldEditor(P_COMMENT_BACKGROUND,
  ...
  protected void addSpellCheckingGroup() {
    ...
    addField(new JJBooleanFieldEditor(P_NO_SPELL_CHECKING, NLS_LABEL_NO_SPELL_CHECKING, //
  ...
  protected void addIndentationGroup() {
    ...
    addField(new JJBooleanFieldEditor(P_NO_ADV_AUTO_INDENT, NLS_LABEL_NO_ADV_AUTO_INDENT, //
                                      tt(NLS_TT_NO_ADV_AUTO_INDENT), composite));

    addField(new JJBooleanFieldEditor(P_INDENT_CHAR, NLS_LABEL_INDENT_CHAR, //
  ...
  protected void addConsoleCommandGroup() {
    ...
    addField(new JJColorFieldEditor(P_CONSOLE_COMMAND, NLS_LABEL_CONSOLE_COMMAND, //
                                    tt(NLS_TT_CONSOLE_COMMAND), composite_1));

    addField(new CycleButtonFieldEditor(P_CONSOLE_COMMAND_ATR, atrLabels, atrValues, //
                                        tt(NLS_TT_FONT_ATR), composite_2));
  ...
  protected void addHyperlinkGroup() {
    ...
    addField(new JJColorFieldEditor(P_HYPERLINK_COLOR, NLS_HYPERLINK_COLOR, //
