...
5) JJDoc compile is available when a .jj or .jjt file is opened.
   Two buttons are actives on toolbar with JavaCC Editor.
6) Editor can help navigate into rules definitions
   double-click on a rule to select it, and right click to "goto definition"
   right click and you can go back too.
